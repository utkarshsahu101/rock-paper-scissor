...
function win(userChoice, computerChoice) {
  ...
  setTimeout(() => userChoiceDiv.classList.remove("green-shadow"), 500);
}
function lose(userChoice, computerChoice) {
  ...
  setTimeout(() => userChoiceDiv.classList.remove("red-shadow"), 500);
}
function draw(userChoice, computerChoice) {
  ...
  setTimeout(() => userChoiceDiv.classList.remove("black-shadow"), 500);
}
