...
function win(userChoice, computerChoice) {
  ...
  setTimeout(() => userChoiceDiv.classList.remove("green-shadow"), 300);
}
function lose(userChoice, computerChoice) {
  ...
  setTimeout(() => userChoiceDiv.classList.remove("red-shadow"), 300);
}
function draw(userChoice, computerChoice) {
  ...
  setTimeout(() => userChoiceDiv.classList.remove("black-shadow"), 300);
}
